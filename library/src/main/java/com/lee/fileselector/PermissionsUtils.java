...
public class PermissionsUtils {
    ...
    private PermissionsUtils.PermissionsResult mPermissionsResult;
    ...
    public void checkPermissions(Activity activity, String[] permissions, PermissionsUtils.PermissionsResult result) {
